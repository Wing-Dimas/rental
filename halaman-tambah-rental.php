...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $idpermainan = $_POST["id_permainan"];
    $tanggalrental = $_POST["tanggal_rental"];
    $tanggalkembali = $_POST["tanggal_kembali"];

    $sql = "CALL tambah_rental_baru(?, ?, ?,?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssss", $idpelanggan, $idpermainan, $tanggalrental, $tanggal_kembali);
    if($stmt->execute()){
        $_SESSION["flash"] = [
            "status" => "success",
        ...
        header("Location: halaman-daftar-rental.php");
...
<aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        ...
        <li>
            <a href="halaman-daftar-game.php">
            <i class="bi bi-circle" ></i><span>Daftar Rental</span>
            </a>
        </li>
        <li>
            <a href="halaman-tambah-game.php" class="active">
            <i class="bi bi-circle"></i><span>Tambah Rental</span>
            </a>
        </li>
        </ul>
        </ul>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Rental</h5>
              ...
              <form class="row g-3" method="post">
                ...
                <div class="col-12">
                  <label for="id_permainan" class="form-label">Id Permainan</label>
                  <input type="text" class="form-control" id="id_permainan" name="id_permainan" required>
                </div>
                <div class="col-12">
                  <label for="tanggal_rental" class="form-label">Tanggal Rental</label>
                  <input type="text" class="form-control" id="tanggal_rental" name="tanggal_rental" required>
                </div>
                <div class="col-12">
