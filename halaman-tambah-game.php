...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $judul = $_POST["judul"];
    $genre = $_POST["genre"];
    $tahunRilis = $_POST["tahun-rilis"];

    $sql = "CALL tambah_permainan_baru(?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sss", $judul, $genre, $tahunRilis);
    if($stmt->execute()){
        $_SESSION["flash"] = [
            "status" => "success",
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Game</h5>
              ...
              <form class="row g-3" method="post">
                ...
                <div class="col-12">
                  <label for="tahun-rilis" class="form-label">Tahun Rilis</label>
                  <input type="text" class="form-control" id="tahun-rilis" name="tahun-rilis" required>
                </div>
