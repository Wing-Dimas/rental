...
<aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        ...
        <li>
            <a href="halaman-daftar-game.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <?php if($flash): ?>
        <div class="alert alert-<?= $flash["status"] ?> alert-dismissible fade show" role="alert">
            <i class="bi <?= $flash["status"] == "success" ? "bi-check-circle" :"bi-exclamation-octagon" ?> me-1"></i>
            <?= $flash["message"] ?>
                ...
                <tbody>
                  ...
                  foreach($daftar_game as $game): ?>
                    <tr>
                      ...
                      <td>
                        <form action="delete-game.php" onSubmit="return confirm('apakah anda yakin?')" method="GET">
                            <input type="hidden" value="<?= $game["id_permainan"]  ?>" name="id">
                           <button type="submit"><i class="bi bi-trash-fill me-1"></i></button>
                        </form>
                      </td>
                    </tr>
                  <?php endforeach ?>
