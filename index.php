        ...
        <ul id="game-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="halaman-daftar-game.php">
              <i class="bi bi-circle"></i><span>Daftar Game</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="halaman-daftar-rental.php">
              <i class="bi bi-circle"></i><span>Daftar Rental</span>
            </a>
          </li>
          <li>
            <a href="halaman-tambah-game.php">
            <i class="bi bi-circle"></i><span>Tambah Game</span>
            </a>
          </li>
          <li>
            <a href="halaman-tambah-pelanggan.php">
            <i class="bi bi-circle"></i><span>Tambah Pelanggan</span>
            </a>
          </li>
          <li>
            <a href="halaman-tambah-rental.php">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Rental Aktif <span>| Today</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Rental Non Aktif <span>| This Month</span></h5>
